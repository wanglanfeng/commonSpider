...
from commonSpiders.scrapy_clusters_manager.context_extend import RedisCacheContextExtend, MongoDbContextExtend
...
if __name__ == '__main__':
    ...
    FlaskRun(app, [RedisCacheContextExtend(priority=3), MongoDbContextExtend(priority=5)]).run()